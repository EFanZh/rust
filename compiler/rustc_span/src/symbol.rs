...
symbols! {
    ...
    Symbols {
        ...
        prelude_import,
        prepend_clear_align,
        prepend_clear_precision,
        prepend_clear_width,
        prepend_fmt_binary,
        prepend_fmt_debug,
        prepend_fmt_debug_noop,
        prepend_fmt_display,
        prepend_fmt_lower_exp,
        prepend_fmt_lower_hex,
        prepend_fmt_octal,
        prepend_fmt_pointer,
        prepend_fmt_upper_exp,
        prepend_fmt_upper_hex,
        prepend_offset_argument_ptr,
        prepend_offset_literal_ptr,
        prepend_set_center_align,
        prepend_set_dyn_precision,
        prepend_set_dyn_width,
        prepend_set_fill,
        prepend_set_flags,
        prepend_set_left_align,
        prepend_set_precision,
        prepend_set_right_align,
        prepend_set_width,
        prepend_write_str,
        preserves_flags,
